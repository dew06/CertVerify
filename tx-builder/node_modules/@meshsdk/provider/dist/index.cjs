...
var U5CProvider = class {
  ...
  async fetchAddressUTxOs(address, asset) {
    ...
    const utxoSearchResult = await this.queryClient.searchUtxosByAddress(new Uint8Array(addressBytes));
   ...
   */
  async fetchUTxOs(hash, index) {
    const txHashBytes = new Uint8Array((0, import_common8.hexToBytes)(hash));
    if (index !== void 0) {
  ...
  _rpcUtxoToMeshUtxo(rpcTxoRef, rpcTxOutput) {
    ...
    if (rpcTxOutput.script !== void 0) {
      if (rpcTxOutput.script.script.case !== "native" && rpcTxOutput.script.script.value) {
        scriptRef = (0, import_common8.bytesToHex)(rpcTxOutput.script.script.value.buffer);
